...
const String sheet_url = "https://script.google.com/macros/s/AKfycbwLTpVTpwHhYSWcjueajQMiN96MmfnpRMaLl8QdwaSx0YEO8EcIiHkmaoptMpKQKQyx/exec?name=";  //Enter Google Script URL
...
//-----------------------------------------
#define WIFI_SSID "sanath7"  //Enter WiFi Name
#define WIFI_PASSWORD "luckluck"  //Enter WiFi Password
//-----------------------------------------
 ...
 void loop()
{
  ...
  for (int j=0 ; j<16 ; j++)
  {
    ...
    lcd.clear();
    lcd.setCursor(0, 0);
    lcd.print("bkname:" + String((char*)readBlockData) + "!");
